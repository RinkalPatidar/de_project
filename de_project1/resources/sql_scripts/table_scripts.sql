...
VALUES
    ...
    ('flour', 20, 20, '2023-03-20', NULL, '2025-01-01'),
    ('gram flour', 52, 52, '2020-05-05', NULL, '2025-01-01'),
    ('refined oil', 110, 110, '2022-01-15', NULL, '2025-01-01'),
    ('shampoo', 1.5, 1.5, '2021-09-25', NULL, '2025-01-01'),
    ('toothpaste', 100, 100, '2023-07-10', NULL, '2025-01-01'),
...
VALUES ('de-rinkal-project-1', 'active', NOW(), NOW());
